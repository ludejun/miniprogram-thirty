...
核心部分是本人另一个仓库：[**wxapp-vedux-webpack**](https://github.com/ludejun/wxapp-webpack) ，将dev和prod都打包到文件夹miniprogram中（也可以示情况分开，修改webpack配置output即可）

再加上云开发函数组成，云开发文档：[云开发文档](https://developers.weixin.qq.com/miniprogram/dev/wxcloud/basis/getting-started.html)
...
### [**wxapp-vedux-webpack**](https://github.com/ludejun/wxapp-webpack)
